...
const GAME_ID = "scribble";
const GAME_NAME = "Scribble";
const GAME_COLOR = "#ffd166";
const GAME_LETTER = "🎨";
const GAME_DESC = "One draws, everyone guesses! Be quick to score.";
const HOW_TO_PLAY = "The drawer picks a word and sketches it. Others guess in chat. Faster guesses = more points!";
const MAX_PLAYERS = 8;

export default function ScribbleLobbyPage() {
