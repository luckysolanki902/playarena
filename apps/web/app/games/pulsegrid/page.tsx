...
const GAME_ID = "pulsegrid";
const GAME_NAME = "PulseGrid";
const GAME_COLOR = "#22d3ee";
const GAME_LETTER = "P";
const GAME_DESC = "Capture territory with strategic pulses. Dominate the grid!";
const HOW_TO_PLAY = "Expand your territory by pulsing into adjacent cells. Capture enemy cells and defend your own!";
const MAX_PLAYERS = 6;

export default function PulseGridLobbyPage() {
