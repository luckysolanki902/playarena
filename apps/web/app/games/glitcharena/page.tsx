...
const GAME_ID = "glitcharena";
const GAME_NAME = "Glitch Arena";
const GAME_COLOR = "#fb923c";
const GAME_LETTER = "G";
const GAME_DESC = "Chaos button madness. Click fast, avoid traps!";
const HOW_TO_PLAY = "Click green buttons for points, avoid red traps. Build combos for bonus multipliers!";
const MAX_PLAYERS = 6;
