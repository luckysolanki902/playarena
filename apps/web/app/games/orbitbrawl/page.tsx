...
const GAME_ID = "orbitbrawl";
const GAME_NAME = "Orbit Brawl";
const GAME_COLOR = "#e879f9";
const GAME_LETTER = "O";
const GAME_DESC = "Push opponents off the arena with magnetic force!";
const HOW_TO_PLAY = "Charge your push/pull force and knock opponents off the arena. Last player standing wins!";
const MAX_PLAYERS = 6;
