...
const GAME_ID = "typerush";
const GAME_NAME = "TypeRush";
const GAME_COLOR = "#a78bfa";
const GAME_LETTER = "T";
const GAME_DESC = "Race to type with glitchy twists! Fastest fingers win.";
const HOW_TO_PLAY = "Type the displayed text as fast as you can. Watch out for glitch effects that scramble your view!";
const MAX_PLAYERS = 6;

export default function TypeRushLobbyPage() {
